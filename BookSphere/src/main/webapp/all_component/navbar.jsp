...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		<div class="col-md-3 text-success">
			<h3>
				<i class="fas fa-book"></i> BookSphare
			</h3>
		</div>
		
		<div class="col md-6">
			<form class="form-inline my-2 my-lg-0" action="search.jsp" method="post">
				<input class="form-control mr-sm-2" type="search" name="seach_name"
		...
		<c:if test="${not empty userobj}">
			<div class="col-md-3">
				...
				<a href="index.jsp" class="btn btn-success"><i class="fas fa-user"></i> ${userobj.name}</a>
