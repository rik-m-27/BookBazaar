...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			List<BookDtls> listRecent = daoRecent.getAllRecentBooks();
			...
			<div class="col-md-3 mt-2">
				<div class="card crd-ho">
					<div class="card-body text-center">
						...
						<div class="row justify-content-center">
							<%if(user==null){%>
								<a href="login.jsp" class="btn btn-danger btn-sm ml"><i class="fas fa-cart-plus"></i> Add cart</a>
							<%}else{%>
								<a href="cart?bid=<%=b.getBookId()%>&&uid=<%=user.getId()%>" class="btn btn-danger btn-sm ml"><i class="fas fa-cart-plus"></i> Add cart</a>						
							<%}%>
